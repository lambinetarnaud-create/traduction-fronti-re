...
const PAYS_VISA = [
  ...
  {pays:"AFRIQUE DU SUD",      code:"ZAF", pp:1, sv:1, dip:0, transit:0, bio:false, note:""},
  ...
  {pays:"ANTIGUA-ET-BARBUDA",  code:"ATG", pp:0, sv:0, dip:0, transit:0, bio:false, note:""},
  ...
  {pays:"BELARUS",             code:"BLR", pp:1, sv:1, dip:0, transit:0, bio:false, note:""},
  ...
  {pays:"BOTSWANA",            code:"BWA", pp:1, sv:1, dip:0, transit:1, bio:false, note:""},
  ...
  {pays:"BULGARIE",            code:"BGR", pp:0, sv:0, dip:0, transit:0, bio:false, note:"UE · Schengen depuis le 01/01/2025"},
  {pays:"BURKINA FASO",        code:"BFA", pp:1, sv:1, dip:0, transit:0, bio:false, note:""},
  {pays:"BURUNDI",             code:"BDI", pp:1, sv:1, dip:0, transit:1, bio:false, note:"VTA requis depuis le 01/08/2026 (art. 3.2 Code des visas). Exemption VTA : PP diplomatiques, de service et spéciaux."},
  {pays:"CABO VERDE",          code:"CPV", pp:1, sv:1, dip:0, transit:0, bio:false, note:""},
  ...
  {pays:"DOMINIQUE",           code:"DMA", pp:0, sv:0, dip:0, transit:0, bio:false, note:"Ne pas confondre avec la REP. DOMINICAINE (DOM), soumise à visa"},
  ...
  {pays:"EQUATEUR",            code:"ECU", pp:1, sv:1, dip:0, transit:0, bio:false, note:""},
  ...
  {pays:"ESWATINI",            code:"SWZ", pp:1, sv:1, dip:0, transit:0, bio:false, note:""},
  {pays:"ETHIOPIE",            code:"ETH", pp:1, sv:1, dip:0, transit:1, bio:false, note:""},
  {pays:"FIDJI",               code:"FJI", pp:1, sv:1, dip:0, transit:0, bio:false, note:""},
  ...
  {pays:"GEORGIE",             code:"GEO", pp:0, sv:1, dip:1, transit:0, bio:true, note:"PP diplomatiques, de service et officiels soumis à visa du 06/03/2026 au 06/03/2027 (règl. UE 2026/496)"},
  ...
  {pays:"JAMAIQUE",            code:"JAM", pp:1, sv:1, dip:0, transit:0, bio:false, note:""},
  ...
  {pays:"KIRGHIZSTAN",         code:"KGZ", pp:1, sv:1, dip:0, transit:0, bio:false, note:""},
  ...
  {pays:"LETTONIE",            code:"LVA", pp:0, sv:0, dip:0, transit:0, bio:false, note:"UE"},
  ...
  {pays:"LITUANIE",            code:"LTU", pp:0, sv:0, dip:0, transit:0, bio:false, note:"UE"},
  ...
  {pays:"NAMIBIE",             code:"NAM", pp:1, sv:1, dip:0, transit:0, bio:false, note:""},
  ...
  {pays:"QATAR",               code:"QAT", pp:1, sv:1, dip:0, transit:0, bio:false, note:""},
  {pays:"REP. CENTRAFRICAINE", code:"CAF", pp:1, sv:1, dip:0, transit:1, bio:false, note:""},
  {pays:"REP. DEM. CONGO",     code:"COD", pp:1, sv:1, dip:0, transit:1, bio:false, note:""},
  {pays:"REP. DOMINICAINE",    code:"DOM", pp:1, sv:1, dip:0, transit:1, bio:false, note:"Ne pas confondre avec la DOMINIQUE (DMA), qui est exemptée"},
  {pays:"ROUMANIE",            code:"ROU", pp:0, sv:0, dip:0, transit:0, bio:false, note:"UE · Schengen depuis le 01/01/2025"},
  {pays:"ROYAUME-UNI",         code:"GBR", pp:0, sv:0, dip:0, transit:0, bio:false, note:""},
  ...
  {pays:"TCHEQUIE",            code:"CZE", pp:0, sv:0, dip:0, transit:0, bio:false, note:"UE"},
  {pays:"THAILANDE",           code:"THA", pp:1, sv:1, dip:0, transit:0, bio:false, note:""},
  {pays:"TIMOR ORIENTAL",      code:"TLS", pp:0, sv:0, dip:0, transit:0, bio:false, note:"Exempté — annexe II (accord UE en application depuis mai 2015)"},
  ...
  {pays:"VANUATU",             code:"VUT", pp:1, sv:1, dip:0, transit:0, bio:false, note:"Annexe I depuis le 03/02/2025 (règl. UE 2025/11)"},
...
function buildNote(p) {
  ...
  if (p.note)        parts.push(`<span style="font-size:.75rem;color:var(--muted);">${esc(p.note)}</span>`);
...
function renderTable(data) {
  ...
  tbody.innerHTML = data.map(p => `
    <tr${p.bio ? ' style="background:#fffbf0;"' : ''}>
      <td><strong>${esc(p.pays)}</strong></td>
      <td><code style="font-size:.8rem;background:#f0f4ff;padding:2px 6px;border-radius:4px;">${esc(p.code)}</code></td>
...
function renderIata(data) {
  ...
  for (var i = 0; i < data.length; i++) {
    ...
    html += "<tr>";
    html += "<td><strong>" + esc(d.ville) + "</strong></td>";
    html += "<td><code style=\"font-size:.85rem;background:#f0f4ff;padding:2px 8px;border-radius:4px;font-weight:700;\">" + esc(d.code) + "</code></td>";
    html += "<td><span style=\"font-size:.75rem;font-weight:500;color:" + color + ";\">" + esc(d.region) + "</span></td>";
    html += "</tr>";
  }
